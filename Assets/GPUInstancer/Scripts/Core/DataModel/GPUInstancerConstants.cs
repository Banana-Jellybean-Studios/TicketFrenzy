...
namespace GPUInstancer
{
    ...
    public static class GPUInstancerConstants
    {
        ...
        public static readonly string BUFFER_TO_TEXTURE_CROSSFADE_KERNEL = "CSBufferToTextureCrossFadeKernel";
        ...
        public static class BufferToTextureKernelPoperties
        {
            ...
            public static readonly int LOD_DATA_TEXTURE = Shader.PropertyToID("gpuiInstanceLODDataTexture");
        }
        ...
        public static readonly string BILLBOARD_SHADER_HDRP_TEMPLATE_MATERIAL_PATH = "Materials/BillboardHDRP_GPUI";
        ...
        public static readonly string ERRORTEXT_shaderGraph = "ShaderGraph shader does not contain GPU Instancer Setup: {0}. Please add GPUInstacer Setup from the ShaderGraph window.";

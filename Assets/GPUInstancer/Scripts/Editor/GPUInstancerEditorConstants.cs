...
namespace GPUInstancer
{
    ...
    {
        public static readonly string GPUI_VERSION = "GPU Instancer v1.7.2";
        public static readonly float GPUI_VERSION_NO = 1.72f;
        ...
        public static readonly string HELPTEXT_detailHealthyColor = "\"Healthy\" color of the the Healthy/Dry noise variation for the prototypes that use the \"GPUInstancer/Foliage\" shader. This corresponds to the \"Healthy Color\" property of the detail prototypes in the Unity terrain. The Healthy/Dry noise texture can be changed globally (terrain specific) for all detail prototypes that use the \"GPUInstancer/Foliage\" shader from the \"Healthy/Dry Noise Texture\" property above.";
